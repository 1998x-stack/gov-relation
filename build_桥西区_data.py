#!/usr/bin/env python3
"""
石家庄市桥西区领导班子工作关系网络 — 2026-07-15（⚠️ 数据待补充）
...
DB_PATH = os.path.join(BASE_DIR, "data/database/桥西区_network.db")
GEXF_PATH = os.path.join(BASE_DIR, "data/graph/桥西区_network.gexf")

# ── PERSONS ──
# (id, name, gender, ethnicity, birth, birthplace, education, party_join, work_start, current_post, current_org, source)
PERSONS = [
    ["桥西区_sec_01", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查", "桥西区委书记（待确认）", "中共石家庄市桥西区委员会", "⚠️ 待确认：桥西区暂无公开数据"],
]

# ── ORGANIZATIONS ──
# (id, name, type, level, parent, location)
ORGANIZATIONS = [
    ["桥西区_party", "中共石家庄市桥西区委员会", "党委", "市辖区", "中共石家庄市委员会", "河北省石家庄市桥西区"],
    ["桥西区_gov", "桥西区人民政府", "政府", "市辖区", "石家庄市人民政府", "河北省石家庄市桥西区"],
]
