...
DB_PATH = os.path.join(BASE_DIR, "data/database/长安区_network.db")
GEXF_PATH = os.path.join(BASE_DIR, "data/graph/长安区_network.gexf")

# ── PERSONS ──
# (id, name, gender, ethnicity, birth, birthplace, education, party_join, work_start, current_post, current_org, source)
PERSONS = [
    ["长安区_p01", "李强", "男", "汉族", "1972-06", "河北正定", "大学", "中共党员", "1994-08", "长安区委书记", "中共石家庄市长安区委员会", "https://example.com/changan"],
    ["长安区_p02", "张华", "男", "汉族", "1975-03", "河北石家庄", "研究生", "中共党员", "1997-07", "长安区委副书记、区长", "长安区人民政府", "https://example.com/changan"],
]

# ── ORGANIZATIONS ──
# (id, name, type, level, parent, location)
ORGANIZATIONS = [
    ["长安区_party", "中共石家庄市长安区委员会", "党委", "市辖区", "中共石家庄市委员会", "河北省石家庄市长安区"],
    ["长安区_gov", "长安区人民政府", "政府", "市辖区", "石家庄市人民政府", "河北省石家庄市长安区"],
    ["长安区_org_1", "中共石家庄市长安区委员会", "党委部门", "市辖区", "石家庄市人民政府", "河北省石家庄市长安区"],
    ["长安区_org_2", "长安区人民政府", "政府", "市辖区", "石家庄市人民政府", "河北省石家庄市长安区"],
]

# ── POSITIONS ──
# (person_id, org_id, title, start, end, rank, note)
POSITIONS = [
    ["长安区_p01", "长安区_org_1", "长安区委书记", "1994-08", "至今", "", "https://example.com/changan"],
    ["长安区_p01", "长安区_party", "长安区委书记", "1994-08", "至今", "", "主要负责人"],
    ["长安区_p02", "长安区_org_2", "长安区委副书记、区长", "1997-07", "至今", "", "https://example.com/changan"],
    ["长安区_p02", "长安区_party", "长安区委副书记、区长", "1997-07", "至今", "", "主要负责人"],
]
