#!/usr/bin/env python3
"""
石家庄市鹿泉区领导班子工作关系网络 — 2026-07-23（⚠️ 数据待补充）
Build script for 鹿泉区 (Luquan District), Shijiazhuang City, Hebei Province.

⚠️ 网络访问受限提示:
   luquan.gov.cn NXDOMAIN — 鹿泉区政府网站已无法访问(域名解析失败)。
   本脚本使用部分已知信息和媒体记录构建，大量字段标记为"待查"。
   建议后续在政府网站恢复后补充官方来源。
...
DB_PATH = os.path.join(BASE_DIR, "data/database/鹿泉区_network.db")
GEXF_PATH = os.path.join(BASE_DIR, "data/graph/鹿泉区_network.gexf")
...
PERSONS = [
    ["鹿泉区_p01", "李为军", "男", "汉族", "待查", "待查", "待查", "中共党员", "待查",
     "石家庄市鹿泉区委书记", "中共石家庄市鹿泉区委员会",
     "⚠️ 需确认：李为军曾任鹿泉区长后升任区委书记，约2019-2020年任现职"],
    ["鹿泉区_p02", "李争", "男", "汉族", "待查", "待查", "待查", "中共党员", "待查",
     "鹿泉区委副书记、区长", "鹿泉区人民政府",
     "⚠️ 需确认：李争约2021-2022年任鹿泉区长"],
]

# ── ORGANIZATIONS ──
# (id, name, type, level, parent, location)
ORGANIZATIONS = [
    ["鹿泉区_party", "中共石家庄市鹿泉区委员会", "党委", "市辖区", "中共石家庄市委员会", "河北省石家庄市鹿泉区"],
    ["鹿泉区_gov", "鹿泉区人民政府", "政府", "市辖区", "石家庄市人民政府", "河北省石家庄市鹿泉区"],
    ["鹿泉区_org_1", "中共石家庄市鹿泉区委员会", "党委部门", "市辖区", "石家庄市人民政府", "河北省石家庄市鹿泉区"],
    ["鹿泉区_org_2", "鹿泉区人民政府", "政府", "市辖区", "石家庄市人民政府", "河北省石家庄市鹿泉区"],
]

# ── POSITIONS ──
# (person_id, org_id, title, start, end, rank, note)
POSITIONS = [
    ["鹿泉区_p01", "鹿泉区_org_1", "石家庄市鹿泉区委书记", "待查", "至今", "", "⚠️ 约2019-2020年任现职"],
    ["鹿泉区_p01", "鹿泉区_party", "石家庄市鹿泉区委书记", "待查", "至今", "", "主要负责人"],
    ["鹿泉区_p02", "鹿泉区_org_2", "鹿泉区委副书记、区长", "待查", "至今", "", "⚠️ 约2021-2022年任现职"],
    ["鹿泉区_p02", "鹿泉区_party", "鹿泉区委副书记、区长", "待查", "至今", "", "主要负责人"],
]

# ── RELATIONSHIPS ──
# (person_a, person_b, type, context, overlap_org, overlap_period)
RELATIONSHIPS = [
    ["鹿泉区_p01", "鹿泉区_p02", "上下级关系",
     "区委书记—区长党政主要领导搭班", "中共石家庄市鹿泉区委员会",
     "待查—至今"],
]
...
def generate_gexf():
    ...
    lines.append(f'    <description>{esc("石家庄市鹿泉区领导班子工作关系网络")}</description>')
...
def print_stats():
    ...
    for table in ["persons", "organizations", "positions", "relationships"]:
        ...
        print(f"  {table}: {cnt}")
        if table == "persons":
            c.execute("SELECT COUNT(*) FROM persons WHERE source LIKE '%待确认%' OR source LIKE '%⚠️%'")
