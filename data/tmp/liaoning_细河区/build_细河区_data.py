...
# Navigate up from data/tmp/liaoning_细河区/ to repo root
...
persons = [
    ...
    # Gap: need to identify the current 细河区委书记
    {
        "id": 1,
        "name": "（待查）",
        "gender": "",
...
if __name__ == "__main__":
    slug = "细河区"
    db_path = os.path.join(BASE, "细河区_network.db")
    gexf_path = os.path.join(BASE, "细河区_network.gexf")
