#!/usr/bin/env python3
"""
石家庄市辛集市领导班子工作关系网络 — 2026-07-15（⚠️ 数据待补充）
...
DB_PATH = os.path.join(BASE_DIR, "data/database/辛集市_network.db")
GEXF_PATH = os.path.join(BASE_DIR, "data/graph/辛集市_network.gexf")

# ── PERSONS ──
# (id, name, gender, ethnicity, birth, birthplace, education, party_join, work_start, current_post, current_org, source)
PERSONS = [
    ["辛集市_sec_01", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查", "辛集市委书记（待确认）", "中共石家庄市辛集市委员会", "⚠️ 待确认：辛集市暂无公开数据"],
]

# ── ORGANIZATIONS ──
# (id, name, type, level, parent, location)
ORGANIZATIONS = [
    ["辛集市_party", "中共石家庄市辛集市委员会", "党委", "县级市", "中共石家庄市委员会", "河北省石家庄市辛集市"],
    ["辛集市_gov", "辛集市人民政府", "政府", "县级市", "石家庄市人民政府", "河北省石家庄市辛集市"],
]
