#!/usr/bin/env python3
"""
吉水县领导班子工作关系网络 — 数据构建脚本
Generates SQLite database + GEXF graph for Jishui County leadership.

Research note: Due to geo-restrictions, Chinese government websites (jishui.gov.cn,
...
All leadership data is pending verification from:
  - https://www.jishui.gov.cn/col/col2524/index.html (吉水县领导之窗)
  - Baidu Baike for each individual
  - 吉安市委组织部任前公示
  - 吉水县人民政府官网

Known from Wikipedia: 县委书记 = 肖梓才 (Xiāo Zǐcái)
County mayor name — unconfirmed in this environment.
"""
...
DB_PATH = os.path.join(BASE_DIR, "吉水县_network.db")
GEXF_PATH = os.path.join(BASE_DIR, "吉水县_network.gexf")

esc = lambda s: str(s).replace("&", "&amp;").replace("<", "&lt;").replace(">", "&gt;").replace('"', "&quot;") if s else ""

# ── DATA ──
# Person ID convention: jishui_{surname_givenname}
...
PERSONS = [
    ...
    # 县委书记 — 肖梓才
    # Source: English Wikipedia (Jishui County page) — "Secretary: Xiāo Zǐcái"
    ("jishui_xiao_zicai", "肖梓才", "男", "汉族", "待查", "待查", "待查", "待查", "待查",
     "县委书记", "中共吉水县委员会",
     "en.wikipedia.org/wiki/Jishui_County — 县委书记已确认；简历细节待查"),

    # ⚠️ 吉水县县长 — 需从 jishui.gov.cn 确认
    ("jishui_mayor_01", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查",
     "县长", "吉水县人民政府",
     "⚠️ 待确认：jishui.gov.cn/col/col2524/index.html"),

    # ═══ Standing Committee (标配县委常委岗位) ═══
    # ⚠️ 县委副书记（专职）
    ("jishui_deputy_sec_01", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查",
     "县委副书记", "中共吉水县委员会", "⚠️ 待确认"),

    # ⚠️ 常务副县长
    ("jishui_exec_vice_mayor_01", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查",
     "县委常委、常务副县长", "吉水县人民政府", "⚠️ 待确认"),

    # ⚠️ 县纪委书记
    ("jishui_discipline_01", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查",
     "县委常委、县纪委书记、县监委主任", "中共吉水县纪律检查委员会", "⚠️ 待确认"),

    # ⚠️ 组织部部长
    ("jishui_org_01", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查",
     "县委常委、组织部部长", "中共吉水县委组织部", "⚠️ 待确认"),

    # ⚠️ 宣传部部长
    ("jishui_propaganda_01", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查",
     "县委常委、宣传部部长", "中共吉水县委宣传部", "⚠️ 待确认"),

    # ⚠️ 政法委书记
    ("jishui_legal_01", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查",
     "县委常委、政法委书记", "中共吉水县委政法委员会", "⚠️ 待确认"),

    # ⚠️ 统战部部长
    ("jishui_united_front_01", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查",
     "县委常委、统战部部长", "中共吉水县委统一战线工作部", "⚠️ 待确认"),

    # ⚠️ 人武部部长/政委
    ("jishui_armed_01", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查",
     "县委常委、人武部政委（或部长）", "吉水县人民武装部", "⚠️ 待确认"),

    # ═══ Vice County Mayors (副县长) ═══
    ("jishui_vice_mayor_01", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查",
     "副县长", "吉水县人民政府", "⚠️ 待确认"),
    ("jishui_vice_mayor_02", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查",
     "副县长", "吉水县人民政府", "⚠️ 待确认"),
    ("jishui_vice_mayor_03", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查",
     "副县长", "吉水县人民政府", "⚠️ 待确认"),
    ("jishui_vice_mayor_04", "（待确认）", "女", "汉族", "待查", "待查", "待查", "待查", "待查",
     "副县长", "吉水县人民政府", "⚠️ 待确认"),

    # ═══ NPC & CPPCC ═══
    ("jishui_npc_chair_01", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查",
     "县人大常委会主任", "吉水县人民代表大会常务委员会", "⚠️ 待确认"),
    ("jishui_cppcc_chair_01", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查",
     "县政协主席", "中国人民政治协商会议吉水县委员会", "⚠️ 待确认"),

    # ═══ Ji'an City-level Leaders (cross-reference) ═══
    ("jishui_yan_yun", "严允", "男", "汉族", "1972-11", "江西石城",
     "南昌大学中文系汉语言文学专业（大学学历）", "1993-11", "1994-07",
     "吉安市委书记", "中共吉安市委", "build_jian_data.py"),
    ("jishui_wang_yanao", "王亚联", "男", "汉族", "待查", "待查",
     "待查", "待查", "待查",
     "吉安市委副书记、市长", "吉安市人民政府",
     "吉安市人民政府网 — 2024年9月任吉安市长"),
    ("jishui_wu_yanling", "吴艳玲", "女", "汉族", "1975-06", "",
     "中央党校大学", "中共党员", "",
     "吉安市委副书记", "中共吉安市委", "build_jian_data.py"),
    ("jishui_chen_dingyu", "陈定宇", "男", "汉族", "1972-05", "",
     "省委党校研究生", "中共党员", "",
     "吉安市委常委、市纪委书记、市监委主任", "中共吉安市纪委", "build_jian_data.py"),
    ("jishui_gong_pingqiu", "龚平秋", "男", "汉族", "1970-06", "",
     "省委党校研究生", "中共党员", "",
...
ORGANIZATIONS = [
    ...
    ("js_party", "中共吉水县委员会", "党委", "县处级", "中共吉安市委", "江西省吉安市吉水县"),
    ("js_gov", "吉水县人民政府", "政府", "县处级", "吉安市人民政府", "江西省吉安市吉水县"),
    ("js_discipline", "中共吉水县纪律检查委员会", "纪委", "县处级", "吉安市纪委监委", "江西省吉安市吉水县"),
    ("js_org", "中共吉水县委组织部", "党委部门", "乡科级", "中共吉水县委", "江西省吉安市吉水县"),
    ("js_propaganda", "中共吉水县委宣传部", "党委部门", "乡科级", "中共吉水县委", "江西省吉安市吉水县"),
    ("js_politics_law", "中共吉水县委政法委员会", "党委部门", "乡科级", "中共吉水县委", "江西省吉安市吉水县"),
    ("js_united_front", "中共吉水县委统一战线工作部", "党委部门", "乡科级", "中共吉水县委", "江西省吉安市吉水县"),
    ("js_armed", "吉水县人民武装部", "军队", "县处级", "吉安军分区", "江西省吉安市吉水县"),
    ("js_npc", "吉水县人民代表大会常务委员会", "人大", "县处级", "吉安市人大常委会", "江西省吉安市吉水县"),
    ("js_cppcc", "中国人民政治协商会议吉水县委员会", "政协", "县处级", "吉安市政协", "江西省吉安市吉水县"),
...
POSITIONS = [
    ...
    {"person_id": "jishui_xiao_zicai", "org_id": "js_party", "title": "县委书记",
     "start": "待查", "end": "", "rank": "县处级正职",
     "note": "肖梓才 — 维基百科确认现任；出生年月、籍贯、教育背景、此前任职履历待查。"},

    # ═══ Current county mayor ═══
    {"person_id": "jishui_mayor_01", "org_id": "js_gov", "title": "县长",
     "start": "待查", "end": "", "rank": "县处级正职",
     "note": "⚠️ 姓名待确认。"},

    # ═══ Deputy Secretary ═══
    {"person_id": "jishui_deputy_sec_01", "org_id": "js_party", "title": "县委副书记（专职）",
     "start": "待查", "end": "", "rank": "县处级副职",
     "note": "⚠️ 姓名待确认。"},

    # ═══ Executive Vice Mayor ═══
    {"person_id": "jishui_exec_vice_mayor_01", "org_id": "js_gov", "title": "县委常委、常务副县长",
     "start": "待查", "end": "", "rank": "县处级副职",
     "note": "⚠️ 姓名待确认。"},

    # ═══ Discipline Secretary ═══
    {"person_id": "jishui_discipline_01", "org_id": "js_discipline", "title": "县委常委、县纪委书记、县监委主任",
     "start": "待查", "end": "", "rank": "县处级副职",
     "note": "⚠️ 姓名待确认。"},

    # ═══ Organization Department Head ═══
    {"person_id": "jishui_org_01", "org_id": "js_org", "title": "县委常委、组织部部长",
     "start": "待查", "end": "", "rank": "县处级副职",
     "note": "⚠️ 姓名待确认。"},

    # ═══ Propaganda Department Head ═══
    {"person_id": "jishui_propaganda_01", "org_id": "js_propaganda", "title": "县委常委、宣传部部长",
     "start": "待查", "end": "", "rank": "县处级副职",
     "note": "⚠️ 姓名待确认。"},

    # ═══ Political-Legal Secretary ═══
    {"person_id": "jishui_legal_01", "org_id": "js_politics_law", "title": "县委常委、政法委书记",
     "start": "待查", "end": "", "rank": "县处级副职",
     "note": "⚠️ 姓名待确认。"},

    # ═══ United Front Head ═══
    {"person_id": "jishui_united_front_01", "org_id": "js_united_front", "title": "县委常委、统战部部长",
     "start": "待查", "end": "", "rank": "县处级副职",
     "note": "⚠️ 姓名待确认。"},

    # ═══ Armed Forces ═══
    {"person_id": "jishui_armed_01", "org_id": "js_armed", "title": "县委常委、人武部政委（或部长）",
     "start": "待查", "end": "", "rank": "县处级副职",
     "note": "⚠️ 姓名待确认；按照惯例，人武部主官之一进入县委常委。"},

    # ═══ Vice Mayors ═══
    {"person_id": "jishui_vice_mayor_01", "org_id": "js_gov", "title": "副县长",
     "start": "待查", "end": "", "rank": "乡科级正职/副处", "note": "⚠️ 姓名待确认。"},
    {"person_id": "jishui_vice_mayor_02", "org_id": "js_gov", "title": "副县长",
     "start": "待查", "end": "", "rank": "乡科级正职/副处", "note": "⚠️ 姓名待确认。"},
    {"person_id": "jishui_vice_mayor_03", "org_id": "js_gov", "title": "副县长",
     "start": "待查", "end": "", "rank": "乡科级正职/副处", "note": "⚠️ 姓名待确认。"},
    {"person_id": "jishui_vice_mayor_04", "org_id": "js_gov", "title": "副县长",
     "start": "待查", "end": "", "rank": "乡科级正职/副处", "note": "⚠️ 姓名待确认。"},

    # ═══ NPC & CPPCC ═══
    {"person_id": "jishui_npc_chair_01", "org_id": "js_npc", "title": "县人大常委会主任",
     "start": "待查", "end": "", "rank": "县处级正职", "note": "⚠️ 姓名待确认。"},
    {"person_id": "jishui_cppcc_chair_01", "org_id": "js_cppcc", "title": "县政协主席",
     "start": "待查", "end": "", "rank": "县处级正职", "note": "⚠️ 姓名待确认。"},

    # ═══ City-level leaders cross-reference ═══
    {"person_id": "jishui_yan_yun", "org_id": "org_jian_cpc", "title": "吉安市委书记",
     "start": "2026-04", "end": "", "rank": "正厅级",
     "note": "现任；2019省交通厅→萍乡组织部长→2020南昌市委副书记→2021宜春市长/书记"},
    {"person_id": "jishui_wang_yanao", "org_id": "org_jian_gov", "title": "吉安市委副书记、市长",
     "start": "2024-09", "end": "", "rank": "正厅级",
     "note": "2024年9月任吉安市长"},
    {"person_id": "jishui_wu_yanling", "org_id": "org_jian_cpc", "title": "吉安市委副书记",
     "start": "~2022-11", "end": "", "rank": "副厅级", "note": "现任"},
    {"person_id": "jishui_chen_dingyu", "org_id": "org_jian_cpc", "title": "吉安市委常委、市纪委书记",
     "start": "~2022", "end": "", "rank": "副厅级", "note": "现任"},
    {"person_id": "jishui_chen_dingyu", "org_id": "org_jian_discipline", "title": "吉安市监委主任",
     "start": "~2022", "end": "", "rank": "副厅级", "note": "现任"},
    {"person_id": "jishui_gong_pingqiu", "org_id": "org_jian_cpc", "title": "吉安市委常委、组织部部长",
     "start": "~2025-10", "end": "", "rank": "副厅级", "note": "现任"},
    {"person_id": "jishui_gong_pingqiu", "org_id": "org_jian_org_dept", "title": "吉安市委组织部部长",
     "start": "~2025-10", "end": "", "rank": "正处级", "note": "现任"},
]

RELATIONSHIPS = [
    # ═══ Secretary ↔ Mayor: 党政正职搭档 ═══
    {"person_a": "jishui_xiao_zicai", "person_b": "jishui_mayor_01",
     "type": "工作关系", "context": "县委书记与县长为吉水县党政正职搭档关系",
     "overlap_org": "吉水县", "overlap_period": "至2026年"},

    # ═══ Secretary ↔ City Secretary: 上下级关系 ═══
    {"person_a": "jishui_xiao_zicai", "person_b": "jishui_yan_yun",
     "type": "上下级关系", "context": "县委书记受吉安市委领导，严允为吉安市委书记",
     "overlap_org": "中共吉安市委-吉水县", "overlap_period": "2026-04至今"},

    # ═══ Secretary ↔ City Mayor ═══
    {"person_a": "jishui_xiao_zicai", "person_b": "jishui_wang_yanao",
     "type": "上下级关系", "context": "县委书记与吉安市市长为上下级党政关系",
     "overlap_org": "吉安市", "overlap_period": "2024-09至今"},

    # ═══ Secretary ↔ Organization Dept Head: 干部管理 ═══
    {"person_a": "jishui_xiao_zicai", "person_b": "jishui_gong_pingqiu",
     "type": "上下级关系", "context": "县管干部工作关系：县委书记与市委组织部部长在干部选拔任用中存在工作互动",
     "overlap_org": "吉安市-吉水县干部体系", "overlap_period": ""},

    # ═══ Secretary ↔ Discipline Head ═══
    {"person_a": "jishui_xiao_zicai", "person_b": "jishui_chen_dingyu",
     "type": "监督关系", "context": "县委书记与市纪委书记为同级党委-纪委关系",
     "overlap_org": "吉安市-吉水县监督体系", "overlap_period": ""},

    # ═══ Secretary ↔ City Deputy Secretary ═══
    {"person_a": "jishui_xiao_zicai", "person_b": "jishui_wu_yanling",
     "type": "上下级关系", "context": "县委受市委领导，县书记与市委副书记为上下级工作关系",
     "overlap_org": "吉安市", "overlap_period": ""},

    # ═══ Secretary ↔ County Discipline: 一岗双责 ═══
    {"person_a": "jishui_xiao_zicai", "person_b": "jishui_discipline_01",
     "type": "工作关系", "context": "县委书记与县纪委书记为同级党委-纪委关系",
     "overlap_org": "中共吉水县委员会", "overlap_period": "至2026年"},

    # ═══ Secretary ↔ Standing Committee members ═══
    {"person_a": "jishui_xiao_zicai", "person_b": "jishui_exec_vice_mayor_01",
     "type": "工作关系", "context": "县委书记与常务副县长为常委会班子关系",
     "overlap_org": "中共吉水县委员会", "overlap_period": "至2026年"},
    {"person_a": "jishui_xiao_zicai", "person_b": "jishui_org_01",
     "type": "工作关系", "context": "县委书记与组织部部长为常委会班子关系",
     "overlap_org": "中共吉水县委员会", "overlap_period": "至2026年"},
    {"person_a": "jishui_xiao_zicai", "person_b": "jishui_propaganda_01",
     "type": "工作关系", "context": "县委书记与宣传部部长为常委会班子关系",
     "overlap_org": "中共吉水县委员会", "overlap_period": "至2026年"},
    {"person_a": "jishui_xiao_zicai", "person_b": "jishui_legal_01",
     "type": "工作关系", "context": "县委书记与政法委书记为常委会班子关系",
     "overlap_org": "中共吉水县委员会", "overlap_period": "至2026年"},
    {"person_a": "jishui_xiao_zicai", "person_b": "jishui_united_front_01",
     "type": "工作关系", "context": "县委书记与统战部部长为常委会班子关系",
     "overlap_org": "中共吉水县委员会", "overlap_period": "至2026年"},

    # ═══ County Mayor ↔ City Leaders ═══
    {"person_a": "jishui_mayor_01", "person_b": "jishui_yan_yun",
     "type": "上下级关系", "context": "县长受市委领导",
     "overlap_org": "吉安市", "overlap_period": "2026-04至今"},
    {"person_a": "jishui_mayor_01", "person_b": "jishui_wang_yanao",
     "type": "上下级关系", "context": "县长受吉安市市长领导",
     "overlap_org": "吉安市", "overlap_period": "2024-09至今"},

    # ═══ NPC Chair ↔ CPC Secretary ═══
    {"person_a": "jishui_npc_chair_01", "person_b": "jishui_xiao_zicai",
     "type": "工作关系", "context": "县人大常委会主任与县委书记为四套班子关系",
     "overlap_org": "吉水县", "overlap_period": "至2026年"},

    # ═══ CPPCC Chair ↔ CPC Secretary ═══
    {"person_a": "jishui_cppcc_chair_01", "person_b": "jishui_xiao_zicai",
...
def build_gexf():
    ...
    lines.append('    <description>吉水县领导班子工作关系网络 — 2026年7月调查，所有信息⚠️待确认</description>')
    lines.append('  </meta>')
...
if __name__ == "__main__":
    print("=" * 60)
    print("  吉水县 (Jishui County) Leadership Network Builder")
