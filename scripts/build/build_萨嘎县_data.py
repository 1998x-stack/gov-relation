#!/usr/bin/env python3
"""Build SQLite DB + GEXF graph for 萨嘎县 (Saga County), 日喀则市, 西藏自治区.

Research status: Web access to Tibet government sites (www.xzsage.gov.cn) and Baidu
...
Key confirmed facts:
- 萨嘎县 is in 日喀则市, 西藏自治区, bordering Nepal
- Admin: 1 town + 7 townships
...
DB_PATH = os.path.join(STAGING, "萨嘎县_network.db")
GEXF_PATH = os.path.join(STAGING, "萨嘎县_network.gexf")
...
# ═══════════════════════════════════════════════════════════════════════
PERSONS = [
    (1,  "（待确认）", "男", "藏族", "", "", "", "", "", "萨嘎县委书记", "中共萨嘎县委员会",
     "待确认 — 萨嘎县人民政府网(www.xzsage.gov.cn) 或 日喀则市委组织部任前公示"),
    (2,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "萨嘎县长", "萨嘎县人民政府",
     "待确认：www.xzsage.gov.cn 或 西藏自治区人民政府网"),
    (3,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "萨嘎县委副书记（专职）", "中共萨嘎县委员会", "待确认"),
    (4,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "萨嘎县委常委、常务副县长", "萨嘎县人民政府", "待确认"),
    (5,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "萨嘎县委常委、纪委书记、监委主任", "中共萨嘎县纪律检查委员会", "待确认"),
    (6,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "萨嘎县委常委、组织部部长", "中共萨嘎县委组织部", "待确认"),
    (7,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "萨嘎县委常委、宣传部部长", "中共萨嘎县委宣传部", "待确认"),
    (8,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "萨嘎县委常委、政法委书记", "中共萨嘎县委政法委员会", "待确认"),
    (9,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "萨嘎县委常委、统战部部长", "中共萨嘎县委统一战线工作部", "待确认"),
    (10, "（待确认）", "男", "藏族", "", "", "", "", "",
     "萨嘎县人大常委会主任", "萨嘎县人民代表大会常务委员会", "待确认"),
    (11, "（待确认）", "男", "藏族", "", "", "", "", "",
     "萨嘎县政协主席", "中国人民政治协商会议萨嘎县委员会", "待确认"),
]

ORGANIZATIONS = [
    (1, "中共萨嘎县委员会", "党委", "县级", "中共日喀则市委员会", "西藏自治区日喀则市萨嘎县"),
    (2, "萨嘎县人民政府", "政府", "县级", "日喀则市人民政府", "西藏自治区日喀则市萨嘎县"),
    (3, "中共萨嘎县纪律检查委员会", "党委", "县级", "中共萨嘎县委员会", "西藏自治区日喀则市萨嘎县"),
    (4, "萨嘎县人民代表大会常务委员会", "人大", "县级", "日喀则市人民代表大会常务委员会", "西藏自治区日喀则市萨嘎县"),
    (5, "政协萨嘎县委员会", "政协", "县级", "政协日喀则市委员会", "西藏自治区日喀则市萨嘎县"),
    (6, "中共萨嘎县委组织部", "党委", "县级", "中共萨嘎县委员会", "西藏自治区日喀则市萨嘎县"),
    (7, "中共萨嘎县委宣传部", "党委", "县级", "中共萨嘎县委员会", "西藏自治区日喀则市萨嘎县"),
    (8, "中共萨嘎县委政法委员会", "党委", "县级", "中共萨嘎县委员会", "西藏自治区日喀则市萨嘎县"),
    (9, "中共萨嘎县委统一战线工作部", "党委", "县级", "中共萨嘎县委员会", "西藏自治区日喀则市萨嘎县"),
    (10, "中共日喀则市委员会", "党委", "地级", "中共西藏自治区委员会", "西藏自治区日喀则市"),
    (11, "日喀则市人民政府", "政府", "地级", "西藏自治区人民政府", "西藏自治区日喀则市"),
]

POSITIONS = [
    (1, 1, "萨嘎县委书记", "", "present", "正处级", "待确认"),
    (2, 2, "萨嘎县长", "", "present", "正处级", "待确认"),
    (2, 1, "萨嘎县委副书记", "", "present", "副处级", "县长兼任"),
    (3, 1, "萨嘎县委副书记（专职）", "", "present", "副处级", "待确认"),
    (4, 2, "萨嘎县委常委、常务副县长", "", "present", "副处级", "待确认"),
    (4, 1, "萨嘎县委常委", "", "present", "副处级", ""),
    (5, 3, "萨嘎县委常委、纪委书记、监委主任", "", "present", "副处级", "待确认"),
    (5, 1, "萨嘎县委常委", "", "present", "副处级", ""),
    (6, 6, "萨嘎县委常委、组织部部长", "", "present", "副处级", "待确认"),
    (6, 1, "萨嘎县委常委", "", "present", "副处级", ""),
    (7, 7, "萨嘎县委常委、宣传部部长", "", "present", "副处级", "待确认"),
    (7, 1, "萨嘎县委常委", "", "present", "副处级", ""),
    (8, 8, "萨嘎县委常委、政法委书记", "", "present", "副处级", "待确认"),
    (8, 1, "萨嘎县委常委", "", "present", "副处级", ""),
    (9, 9, "萨嘎县委常委、统战部部长", "", "present", "副处级", "待确认"),
    (9, 1, "萨嘎县委常委", "", "present", "副处级", ""),
    (10, 4, "萨嘎县人大常委会主任", "", "present", "正处级", "待确认"),
    (11, 5, "萨嘎县政协主席", "", "present", "正处级", "待确认"),
]

RELATIONSHIPS = [
    (1, 2, "superior_subordinate", "萨嘎县委书记与县长搭班子", "中共萨嘎县委员会/萨嘎县人民政府", "待确认"),
    (1, 3, "overlap", "同为萨嘎县委常委", "中共萨嘎县常务委员会", "待确认"),
    (2, 4, "overlap", "县长与常务副县长搭班子", "萨嘎县人民政府", "待确认"),
    (5, 6, "overlap", "同为萨嘎县委常委", "中共萨嘎县常务委员会", "待确认"),
    (7, 8, "overlap", "同为萨嘎县委常委", "中共萨嘎县常务委员会", "待确认"),
    (9, 10, "overlap", "同为萨嘎县领导成员", "萨嘎县", "待确认"),
]
...
def generate_gexf(opath):
    ...
    lines.append(f'    <description>萨嘎县（Saga County）领导班子工作关系网络 — 11 persons, 11 orgs, 6 edges</description>')
    lines.append('  </meta>')
...
if __name__ == "__main__":
    ...
    for ddl in [CREATE_PERSONS, CREATE_ORGANIZATIONS, CREATE_POSITIONS, CREATE_RELATIONSHIPS]:
        conn.execute("DROP TABLE IF EXISTS " + ddl.split()[5])  # drop existing
        conn.execute(ddl)
    ...
    print(f"\nNext steps: verify names from official sources and update")