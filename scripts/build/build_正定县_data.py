#!/usr/bin/env python3
"""
石家庄市正定县领导班子工作关系网络 — 2026-07-15（⚠️ 数据待补充）
...
DB_PATH = os.path.join(BASE_DIR, "data/database/正定县_network.db")
GEXF_PATH = os.path.join(BASE_DIR, "data/graph/正定县_network.gexf")

# ── PERSONS ──
# (id, name, gender, ethnicity, birth, birthplace, education, party_join, work_start, current_post, current_org, source)
PERSONS = [
    ["正定县_sec_01", "（待确认）", "男", "汉族", "待查", "待查", "待查", "待查", "待查", "正定县委书记（待确认）", "中共石家庄市正定县委员会", "⚠️ 待确认：正定县暂无公开数据"],
]

# ── ORGANIZATIONS ──
# (id, name, type, level, parent, location)
ORGANIZATIONS = [
    ["正定县_party", "中共石家庄市正定县委员会", "党委", "县", "中共石家庄市委员会", "河北省石家庄市正定县"],
    ["正定县_gov", "正定县人民政府", "政府", "县", "石家庄市人民政府", "河北省石家庄市正定县"],
]
