#!/usr/bin/env python3
"""Build SQLite database and GEXF graph for 丹江口市, 十堰市, 湖北省.
...
# Future runs should:
#   1) Confirm names from https://www.danjiangkou.gov.cn/ leadership page
...
persons = [
    # ═══════ Core Leadership (NAMES UNCONFIRMED) ═══════
    {
        ...
        "party_join": "",
        "work_start": "",
        "current_post": "丹江口市委书记",
        "current_org": "中共丹江口市委员会",
        "source": "https://www.danjiangkou.gov.cn/"
    },
    {
        "id": 2,
        "name": "待确认",
        ...
        "party_join": "",
        "work_start": "",
        "current_post": "丹江口市人民政府市长",
        "current_org": "丹江口市人民政府",
        "source": "https://www.danjiangkou.gov.cn/"
    },
]

organizations = [
    {"id": 1, "name": "中共丹江口市委员会", "type": "党委", "level": "县级", "parent": "中共十堰市委员会", "location": "十堰市丹江口市"},
    {"id": 2, "name": "丹江口市人民政府", "type": "政府", "level": "县级", "parent": "十堰市人民政府", "location": "十堰市丹江口市"},
    {"id": 3, "name": "中共丹江口市纪律检查委员会/丹江口市监察委员会", "type": "党委", "level": "县级", "parent": "中共十堰市纪律检查委员会", "location": "十堰市丹江口市"},
    {"id": 4, "name": "丹江口市人民代表大会常务委员会", "type": "人大", "level": "县级", "parent": "十堰市人民代表大会常务委员会", "location": "十堰市丹江口市"},
    {"id": 5, "name": "中国人民政治协商会议丹江口市委员会", "type": "政协", "level": "县级", "parent": "政协十堰市委员会", "location": "十堰市丹江口市"},
]

positions = [
    {"person_id": 1, "org_id": 1, "title": "丹江口市委书记", "start_date": "", "end_date": "", "rank": "正处级", "note": "姓名待确认"},
    {"person_id": 2, "org_id": 1, "title": "丹江口市委副书记", "start_date": "", "end_date": "", "rank": "正处级", "note": "姓名待确认"},
    {"person_id": 2, "org_id": 2, "title": "丹江口市人民政府市长", "start_date": "", "end_date": "", "rank": "正处级", "note": "姓名待确认"},
]

relationships = [
    {"person_a": 1, "person_b": 2, "type": "党政搭档", "context": "市委书记与市长为丹江口市党政正职搭档", "overlap_org": "丹江口市", "overlap_period": ""},
]
...
def person_color(name):
    ...
    if name == "待确认" and name:  # catch-all for unknown names
        return "100,100,100"
    return "100,100,100"
...
def write_person_json(person, output_dir):
    ...
    if person.get("source"):
        source_register.append({
            ...
            "notes": "Official leadership page (unable to access during investigation)"
        })
    ...
    data = {
        ...
        "identity": {
            "person_id": f"danjiangkou_{person['name']}",
            "name": person["name"],
            "aliases": [],
        ...
        "open_questions": [
            {
                "priority": "critical",
                "question": f"丹江口市{person['current_post']}的真实姓名和身份",
                "why_it_matters": "当前所有身份信息为待确认占位符，无法进行进一步的履历和关系分析",
                "suggested_queries": [
                    f"丹江口市 {person['current_post']}",
                    f"丹江口市 领导之窗",
                    f"https://www.danjiangkou.gov.cn/xxgk/zfld/"
                ],
