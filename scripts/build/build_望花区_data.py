#!/usr/bin/env python3
"""Build SQLite database, GEXF graph, and person JSONs for 望花区, 抚顺市, 辽宁省.

Investigation date: 2026-07-25
Task ID: liaoning_望花区
Level: 市辖区
Targets: 区委书记 & 区长
...
Research status: WEB ACCESS DEGRADED
  ...
  - Official 望花区政府网站 (www.fswhq.gov.cn): timeout/unreachable
...
_STAGING_CANDIDATE = REPO_ROOT / "data" / "tmp" / "liaoning_望花区"
if _CURRENT_DIR.name == "liaoning_望花区":
...
persons = [
    ...
    # ══════════════════════════════════════════════════════════════════════
    {
        ...
        "work_start": "",
        "current_post": "望花区委书记",
        "current_org": "中共抚顺市望花区委员会",
        "source": "望花区人民政府网站暂无法访问: https://www.fswhq.gov.cn/",
        "confidence": "unverified",
        "notes": "当前望花区委书记姓名待确认。因 www.fswhq.gov.cn 无法访问，暂未能获取区委书记姓名。需要从以下渠道补充：(1) 望花区政府网站领导之窗页；(2) 抚顺市任前公示；(3) 辽宁省组织部干部任免公告。",
    },
    {
        "id": 2,
        "name": "待查望花区长",
        ...
        "source": "望花区人民政府网站暂无法访问: https://www.fswhq.gov.cn/",
        "confidence": "unverified",
        "notes": "当前望花区长姓名待确认。因 www.fswhq.gov.cn 无法访问，暂未能获取区长姓名。需要从以下渠道补充：(1) 望花区政府网站领导之窗页；(2) 抚顺市人大任命公告；(3) 抚顺市人民政府网站县区动态。",
    },
    ...
    },
    {
        ...
        "party_join": "中共党员",
        "work_start": "",
        "current_post": "望花区委常委、组织部部长",
        "current_org": "中共抚顺市望花区委组织部",
        "source": "",
        "confidence": "unverified",
    ...
    },
    {
        ...
        "party_join": "中共党员",
        "work_start": "",
        "current_post": "望花区委常委、纪委书记、区监委主任",
        "current_org": "中共抚顺市望花区纪律检查委员会",
        "source": "",
        "confidence": "unverified",
    ...
    },
    {
        ...
        "party_join": "中共党员",
        "work_start": "",
        "current_post": "望花区委常委、宣传部部长",
        "current_org": "中共抚顺市望花区委宣传部",
        "source": "",
        "confidence": "unverified",
    ...
    },
    {
        ...
        "party_join": "中共党员",
        "work_start": "",
        "current_post": "望花区委常委、政法委书记",
        "current_org": "中共抚顺市望花区委政法委员会",
        "source": "",
        "confidence": "unverified",
...
organizations = [
    {"id": 1, "name": "中共抚顺市望花区委员会", "type": "党委", "level": "县处级", "parent": "中共抚顺市委", "location": "望花区"},
    {"id": 2, "name": "望花区人民政府", "type": "政府", "level": "县处级", "parent": "抚顺市人民政府", "location": "望花区"},
    {"id": 3, "name": "抚顺市望花区人民代表大会常务委员会", "type": "人大", "level": "县处级", "parent": "抚顺市人大常委会", "location": "望花区"},
    {"id": 4, "name": "中国人民政治协商会议抚顺市望花区委员会", "type": "政协", "level": "县处级", "parent": "政协抚顺市委", "location": "望花区"},
    {"id": 5, "name": "中共抚顺市望花区纪律检查委员会（监察委员会）", "type": "纪委", "level": "县处级", "parent": "抚顺市纪委", "location": "望花区"},
    {"id": 6, "name": "中共抚顺市望花区委组织部", "type": "党委", "level": "乡科级", "parent": "中共抚顺市望花区委员会", "location": "望花区"},
    {"id": 7, "name": "中共抚顺市望花区委宣传部", "type": "党委", "level": "乡科级", "parent": "中共抚顺市望花区委员会", "location": "望花区"},
    {"id": 8, "name": "中共抚顺市望花区委政法委员会", "type": "党委", "level": "乡科级", "parent": "中共抚顺市望花区委员会", "location": "望花区"},
    {"id": 9, "name": "中共抚顺市望花区委统一战线工作部", "type": "党委", "level": "乡科级", "parent": "中共抚顺市望花区委员会", "location": "望花区"},
    {"id": 10, "name": "抚顺市望花区公安局", "type": "政府", "level": "乡科级", "parent": "望花区人民政府", "location": "望花区"},
    {"id": 11, "name": "望花区发展和改革局", "type": "政府", "level": "乡科级", "parent": "望花区人民政府", "location": "望花区"},
    {"id": 12, "name": "望花区教育局", "type": "政府", "level": "乡科级", "parent": "望花区人民政府", "location": "望花区"},
    {"id": 13, "name": "望花区财政局", "type": "政府", "level": "乡科级", "parent": "望花区人民政府", "location": "望花区"},
    {"id": 14, "name": "望花区住房和城乡建设局", "type": "政府", "level": "乡科级", "parent": "望花区人民政府", "location": "望花区"},
    {"id": 15, "name": "望花区工业和信息化局", "type": "政府", "level": "乡科级", "parent": "望花区人民政府", "location": "望花区"},
    {"id": 16, "name": "望花区民政局", "type": "政府", "level": "乡科级", "parent": "望花区人民政府", "location": "望花区"},
    {"id": 17, "name": "望花区卫生健康局", "type": "政府", "level": "乡科级", "parent": "望花区人民政府", "location": "望花区"},
    {"id": 18, "name": "抚顺市望花区人民法院", "type": "政府", "level": "县处级", "parent": "抚顺市中级人民法院", "location": "望花区"},
    {"id": 19, "name": "抚顺市望花区人民检察院", "type": "政府", "level": "县处级", "parent": "抚顺市人民检察院", "location": "望花区"},
]

# ── Positions ────────────────────────────────────────────────────────────────
positions = [
    # 区委书记
    {"person_id": 1, "org_id": 1, "title": "望花区委书记", "start_date": "", "end_date": "", "rank": "县处级正职",
     "note": "当前望花区委书记，姓名待确认"},
    # 区长
    {"person_id": 2, "org_id": 2, "title": "区长", "start_date": "", "end_date": "", "rank": "县处级正职",
     "note": "望花区人民政府区长，姓名待确认"},
    {"person_id": 2, "org_id": 1, "title": "望花区委副书记", "start_date": "", "end_date": "", "rank": "县处级正职",
     "note": "区长兼任区委副书记"},
    # 常务副区长
    {"person_id": 3, "org_id": 1, "title": "望花区委常委", "start_date": "", "end_date": "", "rank": "县处级副职", "note": ""},
    {"person_id": 3, "org_id": 2, "title": "常务副区长", "start_date": "", "end_date": "", "rank": "县处级副职",
     "note": "区政府党组副书记，分管常务工作"},
    # 组织部长
    {"person_id": 4, "org_id": 1, "title": "望花区委常委", "start_date": "", "end_date": "", "rank": "县处级副职", "note": ""},
    {"person_id": 4, "org_id": 6, "title": "组织部部长", "start_date": "", "end_date": "", "rank": "县处级副职", "note": ""},
    # 纪委书记
    {"person_id": 5, "org_id": 1, "title": "望花区委常委", "start_date": "", "end_date": "", "rank": "县处级副职", "note": ""},
    {"person_id": 5, "org_id": 5, "title": "纪委书记、区监委主任", "start_date": "", "end_date": "", "rank": "县处级副职", "note": ""},
    # 宣传部长
    {"person_id": 6, "org_id": 1, "title": "望花区委常委", "start_date": "", "end_date": "", "rank": "县处级副职", "note": ""},
    {"person_id": 6, "org_id": 7, "title": "宣传部部长", "start_date": "", "end_date": "", "rank": "县处级副职", "note": ""},
    # 政法委书记
    {"person_id": 7, "org_id": 1, "title": "望花区委常委", "start_date": "", "end_date": "", "rank": "县处级副职", "note": ""},
...
relationships = [
    # 党政正职搭档 — unverified
    {
        ...
        "context": "望花区委书记与区长为当前党政主要领导搭档关系（姓名待确认）",
        "overlap_org": "中共抚顺市望花区委员会/望花区人民政府",
        "overlap_period": "当前",
        "confidence": "unverified",
    },
    # 常务副区长与区长
...
def build_person_json(person_id: int) -> dict:
    ...
    person = {
        "identity": {
            "person_id": f"liaoning_fushun_wanghua_{name}",
            "name": name,
            "aliases": [],
            "gender": p["gender"],
    ...
    for r in person_rels:
        ...
        person["relationships"].append({
            "person": other_name,
            "person_id": f"liaoning_fushun_wanghua_{other_name}",
    ...
    if "待查" in name:
        person["open_questions"].append({
            "priority": "critical",
            "question": f"望花区{role_label}姓名是什么？",
    ...
    if not p.get("birth"):
        person["open_questions"].append({
            ...
            "suggested_queries": [f"望花区 {name} 简历"],
            "last_attempted": AS_OF,
        })
