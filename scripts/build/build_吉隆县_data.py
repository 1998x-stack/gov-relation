#!/usr/bin/env python3
"""Build SQLite DB + GEXF graph for 吉隆县 (Gyirong County), 日喀则市, 西藏自治区.

Research status: Web access to Tibet government sites (www.xzgilong.gov.cn) and Baidu
unavailable from this environment. Wikipedia county background available.
Leadership information compiled with explicit confidence labels — all names pending verification.

Key confirmed facts:
- 吉隆县 is in 日喀则市, 西藏自治区, bordering Nepal
- Admin: 2 towns + 4 townships (宗嘎镇, 吉隆镇, 差那乡, 折巴乡, 贡当乡, 萨勒乡)
- County-level (县级) administrative unit
- Population: ~17,536 (2020 census)
"""
...
DB_PATH = os.path.join(STAGING, "吉隆县_network.db")
GEXF_PATH = os.path.join(STAGING, "吉隆县_network.gexf")
...
# ═══════════════════════════════════════════════════════════════════════
PERSONS = [
    (1,  "（待确认）", "男", "藏族", "", "", "", "", "", "吉隆县委书记", "中共吉隆县委员会",
     "待确认 — 吉隆县政府网(www.xzgilong.gov.cn) 或 日喀则市委组织部任前公示"),
    (2,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "吉隆县长", "吉隆县人民政府",
     "待确认：www.xzgilong.gov.cn 或 西藏自治区人民政府网"),
    (3,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "吉隆县委副书记（专职）", "中共吉隆县委员会", "待确认"),
    (4,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "吉隆县委常委、常务副县长", "吉隆县人民政府", "待确认"),
    (5,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "吉隆县委常委、纪委书记、监委主任", "中共吉隆县纪律检查委员会", "待确认"),
    (6,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "吉隆县委常委、组织部部长", "中共吉隆县委组织部", "待确认"),
    (7,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "吉隆县委常委、宣传部部长", "中共吉隆县委宣传部", "待确认"),
    (8,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "吉隆县委常委、政法委书记", "中共吉隆县委政法委员会", "待确认"),
    (9,  "（待确认）", "男", "藏族", "", "", "", "", "",
     "吉隆县委常委、统战部部长", "中共吉隆县委统一战线工作部", "待确认"),
    (10, "（待确认）", "男", "藏族", "", "", "", "", "",
     "吉隆县人大常委会主任", "吉隆县人民代表大会常务委员会", "待确认"),
    (11, "（待确认）", "男", "藏族", "", "", "", "", "",
     "吉隆县政协主席", "中国人民政治协商会议吉隆县委员会", "待确认"),
]

ORGANIZATIONS = [
    (1, "中共吉隆县委员会", "党委", "县级", "中共日喀则市委员会", "西藏自治区日喀则市吉隆县"),
    (2, "吉隆县人民政府", "政府", "县级", "日喀则市人民政府", "西藏自治区日喀则市吉隆县"),
    (3, "中共吉隆县纪律检查委员会", "党委", "县级", "中共吉隆县委员会", "西藏自治区日喀则市吉隆县"),
    (4, "吉隆县人民代表大会常务委员会", "人大", "县级", "日喀则市人民代表大会常务委员会", "西藏自治区日喀则市吉隆县"),
    (5, "政协吉隆县委员会", "政协", "县级", "政协日喀则市委员会", "西藏自治区日喀则市吉隆县"),
    (6, "中共吉隆县委组织部", "党委", "县级", "中共吉隆县委员会", "西藏自治区日喀则市吉隆县"),
    (7, "中共吉隆县委宣传部", "党委", "县级", "中共吉隆县委员会", "西藏自治区日喀则市吉隆县"),
    (8, "中共吉隆县委政法委员会", "党委", "县级", "中共吉隆县委员会", "西藏自治区日喀则市吉隆县"),
    (9, "中共吉隆县委统一战线工作部", "党委", "县级", "中共吉隆县委员会", "西藏自治区日喀则市吉隆县"),
    (10, "中共日喀则市委员会", "党委", "地级", "中共西藏自治区委员会", "西藏自治区日喀则市"),
    (11, "日喀则市人民政府", "政府", "地级", "西藏自治区人民政府", "西藏自治区日喀则市"),
]

POSITIONS = [
    (1, 1, "吉隆县委书记", "", "present", "正处级", "待确认"),
    (2, 2, "吉隆县长", "", "present", "正处级", "待确认"),
    (2, 1, "吉隆县委副书记", "", "present", "副处级", "县长兼任"),
    (3, 1, "吉隆县委副书记（专职）", "", "present", "副处级", "待确认"),
    (4, 2, "吉隆县委常委、常务副县长", "", "present", "副处级", "待确认"),
    (4, 1, "吉隆县委常委", "", "present", "副处级", ""),
    (5, 3, "吉隆县委常委、纪委书记、监委主任", "", "present", "副处级", "待确认"),
    (5, 1, "吉隆县委常委", "", "present", "副处级", ""),
    (6, 6, "吉隆县委常委、组织部部长", "", "present", "副处级", "待确认"),
    (6, 1, "吉隆县委常委", "", "present", "副处级", ""),
    (7, 7, "吉隆县委常委、宣传部部长", "", "present", "副处级", "待确认"),
    (7, 1, "吉隆县委常委", "", "present", "副处级", ""),
    (8, 8, "吉隆县委常委、政法委书记", "", "present", "副处级", "待确认"),
    (8, 1, "吉隆县委常委", "", "present", "副处级", ""),
    (9, 9, "吉隆县委常委、统战部部长", "", "present", "副处级", "待确认"),
    (9, 1, "吉隆县委常委", "", "present", "副处级", ""),
    (10, 4, "吉隆县人大常委会主任", "", "present", "正处级", "待确认"),
    (11, 5, "吉隆县政协主席", "", "present", "正处级", "待确认"),
]

RELATIONSHIPS = [
    (1, 2, "superior_subordinate", "吉隆县委书记与县长搭班子", "中共吉隆县委员会/吉隆县人民政府", "待确认"),
    (1, 3, "overlap", "同为吉隆县委常委", "中共吉隆县常务委员会", "待确认"),
    (2, 4, "overlap", "县长与常务副县长搭班子", "吉隆县人民政府", "待确认"),
    (5, 6, "overlap", "同为吉隆县委常委", "中共吉隆县常务委员会", "待确认"),
    (7, 8, "overlap", "同为吉隆县委常委", "中共吉隆县常务委员会", "待确认"),
    (9, 10, "overlap", "同为吉隆县领导成员", "吉隆县", "待确认"),
]
...
def generate_gexf(opath):
    ...
    lines.append(f'    <description>吉隆县（Gyirong County）领导班子工作关系网络 — 11 persons, 11 orgs, 6 edges</description>')
    lines.append('  </meta>')
...
if __name__ == "__main__":
    ...
    print(f"  ⚠️  All leadership names pending verification — web access degraded")
    ...
    print(f"\nNext steps: Verify names from official sources and update PERSONS dict")

    # Verify files exist
    for fpath in [DB_PATH, GEXF_PATH]:
