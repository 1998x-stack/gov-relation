...
persons = [
    ...
    {"id": 4, "name": "方璐", "gender": "女", "ethnicity": "汉族",
     "birth": "1979-06", "birthplace": "江西兴国", "education": "大学，南昌大学法学硕士",
     "party_join": "2003-04", "work_start": "2000-07",
     "current_post": "（去向待查，仍在鹰潭市范围内）", "current_org": "",
...
positions = [
    ...
    # 方璐
    {"person_id": 4, "org_id": 13, "title": "共青团鹰潭市委学少部副部长、部长，工农青年部部长，办公室主任、党组成员", "start": "2000-07", "end": "2004-03", "rank": "", "note": "期间在白露镇、高公寨乡挂职"},
