...
DB_PATH = os.path.join(BASE_DIR, "data/database/新华区_network.db")
GEXF_PATH = os.path.join(BASE_DIR, "data/graph/新华区_network.gexf")

# ── PERSONS ──
# (id, name, gender, ethnicity, birth, birthplace, education, party_join, work_start, current_post, current_org, source)
PERSONS = [
    ["新华区_p01", "王明", "男", "汉族", "1971-11", "河北保定", "大学", "中共党员", "1993-09", "新华区委书记", "中共石家庄市新华区委员会", "https://example.com/xinhua"],
]

# ── ORGANIZATIONS ──
# (id, name, type, level, parent, location)
ORGANIZATIONS = [
    ["新华区_party", "中共石家庄市新华区委员会", "党委", "市辖区", "中共石家庄市委员会", "河北省石家庄市新华区"],
    ["新华区_gov", "新华区人民政府", "政府", "市辖区", "石家庄市人民政府", "河北省石家庄市新华区"],
    ["新华区_org_1", "中共石家庄市新华区委员会", "党委部门", "市辖区", "石家庄市人民政府", "河北省石家庄市新华区"],
]

# ── POSITIONS ──
# (person_id, org_id, title, start, end, rank, note)
POSITIONS = [
    ["新华区_p01", "新华区_org_1", "新华区委书记", "1993-09", "至今", "", "https://example.com/xinhua"],
    ["新华区_p01", "新华区_party", "新华区委书记", "1993-09", "至今", "", "主要负责人"],
]
